...
## Efficiency ($\mat{\eta}_{fu}$) and exergy-to-energy ratio ($\mat{\phi}$) vectors

Next, vectors containing final-to-useful energy efficiencies ($\mat{\eta}_{fu}$) and
exergy-to-energy ratios ($\mat{\phi}$) must be formed
...
psut_mats_useful <- psut_mats_final %>% 
  extend_to_useful(wide_C_data = C_mats, 
                   wide_eta_fu_data = eta_fu_vecs)
...
If everything is done correctly, energy balance is preserved in the energy conversion chains.
