...
Note that when the `matnames` column already exists in the data frame,
then the `add_psut_matnames()` returns the input data frame without modifying it.
...
Note that if the `rowname`, `colname`, `rowtype`, and `coltype` columns
are already present in the data frame, then the `add_row_col_meta()` function
returns the input data frame without modifying it. 
If some of the `rowname`, `colname`, `rowtype`, and `coltype` columns
are present in the data frame, but not all of them, then the function
returns an error.
