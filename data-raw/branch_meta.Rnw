...
* Purpose: To apply a specification for situations where
           an industry makes a product all of which it consumes 
           exclusively with EIOU.
           In this situation, calculating the IO matrices results
           in a singular matrix.
* Next step: Merge back into develop when successful.
